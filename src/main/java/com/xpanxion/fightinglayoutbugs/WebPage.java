...
import com.xpanxion.fightinglayoutbugs.ScreenshotCache.Condition;
import com.xpanxion.fightinglayoutbugs.helpers.RectangularRegion;
...
import static com.xpanxion.fightinglayoutbugs.helpers.StringHelper.asString;
...
public class WebPage {
    ...
    private void injectJQueryIfNotPresent() {
        ...
        if ("undefined".equals(executeJavaScript("return typeof jQuery"))) {
            String jquery = readResource("jquery-3.3.0.min.js");
            executeJavaScript(jquery);
            // Check if jQuery was successfully injected ...
            if (!"3.3.0".equals(executeJavaScript("return jQuery.fn.jquery"))) {
